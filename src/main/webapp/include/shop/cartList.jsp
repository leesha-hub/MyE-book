			...
			<section id="content">
				...
				<ul>
					...
					<c:forEach items="${cartList}" var="cartList">
						<li>
							...
							<div class="thumb">
								<img src="${cartList.thumbImg}" />
							</div>
							<div class="gdsInfo">
								<p>
									<span>상품명 : </span>${cartList.bookname}<br /> <span>판매
										유형 : </span>${cartList.sellingtype}<br /> <span>개당 가격 : </span>
								...
								<div class="delete">
									<button type="button" class="delete${cartList.num}btn"
										data-cartNum="${cartList.num}">삭제</button>

									<script>
										$(".delete${cartList.num}btn")
												.click(
														function() {
															var confirm_val = confirm("정말 삭제하시겠습니까?");
						...
						<c:set var="sum"
							value="${sum + (cartList.price * cartList.cartStock)}" />
					</c:forEach>
				</ul>
				...
				<div class="orderInfo">
					<form role="form" method="post" autocomplete="off"
						action="${pageContext.request.contextPath}/orderList.do">
					  ...
					  <div class="inputArea">
					   ...
					   <input type="text" name="userAddr3" id="userAddr3" required="required" />
						...
						<div class="inputArea">
							<p>
								<input type="text" id="sample2_postcode" name="userAddr1"
