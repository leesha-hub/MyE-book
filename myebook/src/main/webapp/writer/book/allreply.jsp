			...
			<div id="container_box">
			 <ul>
			  ...
			  <li>
			   <div class="replyInfo">
			    <p>
			     <span>작성자</span>${reply.nickname} (${reply.user_id})
			    </p>
			    <p>
			     <span>작성된 상품</span> <a href="./view.do?n=${reply.bkid}">바로가기</a>
			    </p>
			   </div>
			   ...
			   <form role = "form" method = "post" action = "${pageContext.request.contextPath}/deleteReply">
			   <input type = "hidden" name = "rid" value = "${reply.rid}"/>
			 <button type="submit" class="delete_${reply.rid}_btn">삭제</button>
			</form>
			</div>
